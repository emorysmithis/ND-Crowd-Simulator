...
def load_students(students_file, p_walk, p_scooter, p_bike):
...
if __name__ == '__main__':
    ...
    N = int(sys.argv[4])                    # N
    p_walk = int(sys.argv[5])               # transportation
    p_scooter = int(sys.argv[6])
    p_bike = int(sys.argv[7])

    # Data
    crowding_dict = {}
    graph, buildings_dict = setup_osm('Notre Dame, Indiana, United States') 
    table = load_students(students_file, p_walk, p_scooter, p_bike)
